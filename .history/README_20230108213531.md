...
<p align="center">
  <img alt="dashboard" src="./src/assets/Screenshot (14).png" width="100%">
  <img alt="cadastrar-transacao" src="./src/assets/Screenshot (15).png" width="100%">
</p>
